    ...
    posts: [
      ...
      },
      {
        ...
        body: [
          {
            type: 'heading',
            model: { text: 'Nam eu varius magna, vel molestie diam' },
          },
          {
            type: 'image',
            model: {
      ...
      },
      {
        ...
        body: [
          ...
          },
          {
            ...
            model: {
              text:
                'Nunc auctor porttitor est, sed laoreet tortor mattis eget.',
            },
          },
          {
            type: 'list',
...
export default RankPostsPropsInit;